...
public enum ErrorCode {
    ...
    GITHUB_BRANCH_UPDATE_FORBIDDEN(HttpStatus.FORBIDDEN, "GitHub 토큰에 쓰기 권한이 없거나 보호 브랜치라서 push할 수 없습니다."),
    GITHUB_BRANCH_NOT_FOUND(HttpStatus.NOT_FOUND, "Push 대상 GitHub 브랜치를 찾을 수 없습니다."),
    GITHUB_BRANCH_UPDATE_REJECTED(HttpStatus.UNPROCESSABLE_ENTITY, "GitHub가 브랜치 갱신을 거절했습니다. 저장소 규칙을 확인해주세요."),
    GITHUB_BRANCH_UPDATE_API_FAILED(HttpStatus.BAD_GATEWAY, "GitHub 브랜치 갱신 요청에 실패했습니다."),
